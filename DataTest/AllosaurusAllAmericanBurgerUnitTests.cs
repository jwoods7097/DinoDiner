namespace DataTest
{
    ...
    public class AllosaurusAllAmericanBurgerUnitTests
    {
        ...
        /// <summary>
        /// AllosaurusAllAmericanBurger should implement the INotifyPropertyChanged interface
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// AllosaurusAllAmericanBurger can be cast as MenuItem
        /// </summary>
        [Fact]
        ...
        {
            AllosaurusAllAmericanBurger b = new();
            string instruction = "Hold Mustard"; // Ensures string will be the same in both asserts
            b.Mustard = false;
            Assert.Contains<string>(instruction, b.SpecialInstructions);
            b.Mustard = true;
            Assert.DoesNotContain<string>(instruction, b.SpecialInstructions);
        ...
        /// <summary>
        /// AllosaurusAllAmericanBurger can be cast as Burger
        /// </summary>
        [Fact]
